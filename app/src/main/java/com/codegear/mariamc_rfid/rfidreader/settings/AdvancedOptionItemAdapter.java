 ...
 * specified {@link AdvancedOptionItemFragment.OnAdvancedListFragmentInteractionListener}.
...
public class AdvancedOptionItemAdapter extends RecyclerView.Adapter<AdvancedOptionItemAdapter.ViewHolder> {
    ...
    private final AdvancedOptionItemFragment.OnAdvancedListFragmentInteractionListener mListener;

    public AdvancedOptionItemAdapter(List<AdvancedOptionsContent.SettingItem> items, AdvancedOptionItemFragment.OnAdvancedListFragmentInteractionListener listener) {
        mValues = items;
        mListener = listener;
    }
