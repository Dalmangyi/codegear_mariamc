...
import static com.zebra.scannercontrol.RMDAttributes.RMD_ATTR_VALUE_ACTION_FAST_WARBLE_BEEP;
...
import static com.zebra.scannercontrol.RMDAttributes.RMD_ATTR_VALUE_ACTION_HIGH_LONG_BEEP_2;
import static com.zebra.scannercontrol.RMDAttributes.RMD_ATTR_VALUE_ACTION_HIGH_LONG_BEEP_3;
import static com.zebra.scannercontrol.RMDAttributes.RMD_ATTR_VALUE_ACTION_HIGH_LONG_BEEP_4;
import static com.zebra.scannercontrol.RMDAttributes.RMD_ATTR_VALUE_ACTION_HIGH_LONG_BEEP_5;
import static com.zebra.scannercontrol.RMDAttributes.RMD_ATTR_VALUE_ACTION_HIGH_LOW_BEEP;
import static com.zebra.scannercontrol.RMDAttributes.RMD_ATTR_VALUE_ACTION_HIGH_LOW_HIGH_BEEP;
import static com.zebra.scannercontrol.RMDAttributes.RMD_ATTR_VALUE_ACTION_HIGH_SHORT_BEEP_1;
import static com.zebra.scannercontrol.RMDAttributes.RMD_ATTR_VALUE_ACTION_HIGH_SHORT_BEEP_2;
import static com.zebra.scannercontrol.RMDAttributes.RMD_ATTR_VALUE_ACTION_HIGH_SHORT_BEEP_3;
import static com.zebra.scannercontrol.RMDAttributes.RMD_ATTR_VALUE_ACTION_HIGH_SHORT_BEEP_4;
import static com.zebra.scannercontrol.RMDAttributes.RMD_ATTR_VALUE_ACTION_HIGH_SHORT_BEEP_5;
import static com.zebra.scannercontrol.RMDAttributes.RMD_ATTR_VALUE_ACTION_LOW_HIGH_BEEP;
import static com.zebra.scannercontrol.RMDAttributes.RMD_ATTR_VALUE_ACTION_LOW_HIGH_LOW_BEEP;
import static com.zebra.scannercontrol.RMDAttributes.RMD_ATTR_VALUE_ACTION_LOW_LONG_BEEP_1;
import static com.zebra.scannercontrol.RMDAttributes.RMD_ATTR_VALUE_ACTION_LOW_LONG_BEEP_2;
import static com.zebra.scannercontrol.RMDAttributes.RMD_ATTR_VALUE_ACTION_LOW_LONG_BEEP_3;
import static com.zebra.scannercontrol.RMDAttributes.RMD_ATTR_VALUE_ACTION_LOW_LONG_BEEP_4;
import static com.zebra.scannercontrol.RMDAttributes.RMD_ATTR_VALUE_ACTION_LOW_LONG_BEEP_5;
import static com.zebra.scannercontrol.RMDAttributes.RMD_ATTR_VALUE_ACTION_LOW_SHORT_BEEP_1;
import static com.zebra.scannercontrol.RMDAttributes.RMD_ATTR_VALUE_ACTION_LOW_SHORT_BEEP_2;
import static com.zebra.scannercontrol.RMDAttributes.RMD_ATTR_VALUE_ACTION_LOW_SHORT_BEEP_3;
import static com.zebra.scannercontrol.RMDAttributes.RMD_ATTR_VALUE_ACTION_LOW_SHORT_BEEP_4;
import static com.zebra.scannercontrol.RMDAttributes.RMD_ATTR_VALUE_ACTION_LOW_SHORT_BEEP_5;
import static com.zebra.scannercontrol.RMDAttributes.RMD_ATTR_VALUE_ACTION_SLOW_WARBLE_BEEP;
...
public class BeeperActionsActivity extends BaseActivity implements NavigationView.OnNavigationItemSelectedListener,ScannerAppEngine.IScannerAppEngineDevConnectionsDelegate, SeekBar.OnSeekBarChangeListener {
    ...
    private class MyAsyncTask extends AsyncTask<String,Integer,Boolean> {
        ...
        protected void onPreExecute() {
            super.onPreExecute();
            progressDialog = new CustomProgressDialog(BeeperActionsActivity.this, "신호음 동작을 실행하는 중입니다..");
            progressDialog.show();
        }
        ...
        protected void onPostExecute(Boolean b) {
            ...
            if(!b){
                Toast.makeText(BeeperActionsActivity.this, "신호음 작업을 수행할 수 없습니다.", Toast.LENGTH_SHORT).show();
            }
        }
    }
}
